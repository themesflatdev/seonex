...
(function (__wpcc) {
    var r = function (a) {
            return h
                ...
                : a && "object" === typeof a && null !== a && 1 === a.nodeType && "string" === typeof a.nodeName;
        },
        t = function (a, b) {
    ...
    y.prototype.setPosition = function (a, b, c) {
        ...
        a < c.left + e
            ? (a = c.left + e)
            : a + this.el.clientWidth > c.left + c.width + e && (a = c.left + c.width - this.el.clientWidth + e);
        b < c.top + f
            ? (b = c.top + f)
            : b + this.el.clientHeight > c.top + c.height + f && (b = c.top + c.height - this.el.clientHeight + f);
    ...
    z.prototype._bindEvents = function () {
        ...
        this.settings.handleTouch
            ...
            : (this.settings.el.addEventListener("touchstart", this._preventDefault, a),
    ...
    A.prototype.setPosition = function (a, b, c) {
        ...
        this.el.parentElement === this.settings.inlineContainer &&
            ...
            this.settings.containInline &&
                (a < c.left + p ? (a = c.left + p) : a + q > c.left + c.width + p && (a = c.left + c.width - q + p),
